...
async def get_ai_settings(
    ...
    settings_dict = await FirestoreService.get_user_settings(userId, "ai_config")
    ...
    if "api_key" in settings_dict and settings_dict["api_key"]:
        ...
        if provider not in settings_dict["configs"] or not settings_dict["configs"][provider].get("api_key"):
            ...
            await FirestoreService.update_user_settings(userId, "ai_config", settings_dict)
...
async def update_ai_settings(
    ...
    current = await FirestoreService.get_user_settings(userId, "ai_config") or {}
    ...
    await FirestoreService.update_user_settings(userId, "ai_config", current)
...
async def test_ai_settings(
    ...
    if api_key.startswith("********"):
        current = await FirestoreService.get_user_settings(userId, "ai_config")
